...
__asm__(
    ...
    ".ascii \"				end\\n\"\n"
    ".ascii \"				if $type == 5\\n\"\n"
    ".ascii \"					set $bigstr = (zend_string *)zend_int_debug_str($zvalue, 40)\\n\"\n"
    ".ascii \"					printf \\\"bigint(%s)\\\", (char*)$bigstr->val\\n\"\n"
    ".ascii \"				end\\n\"\n"
    ".ascii \"				if $type == 6\\n\"\n"
    ...
    ".ascii \"	set $type = $zvalue->u1.v.type\\n\"\n"
    ".ascii \"\\n\"\n"
    ".ascii \"	# 13 == IS_INDIRECT\\n\"\n"
    ".ascii \"	if ($type == 5) || ($type > 6 && $type < 13)\\n\"\n"
    ...
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 15\\n\"\n"
    ".ascii \"		printf \\\"alias pointer: %p\\\", $zvalue->value.ptr\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if $type == 16\\n\"\n"
    ".ascii \"		printf \\\"_ERROR\\\"\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ...
    ".ascii \"	end\\n\"\n"
    ".ascii \"	if ($type == 17) || ($type == 18) || ($type > 20)\\n\"\n"
    ".ascii \"		printf \\\"unknown type %d\\\", $type\\n\"\n"
    ".ascii \"	end\\n\"\n"
    ".ascii \"	printf \\\"\\\\\\\\n\\\"\\n\"\n"
    ".ascii \"end\\n\"\n"
