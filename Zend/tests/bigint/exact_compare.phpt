...
check('2 ** 63 - 1 == (float) (2 ** 63 - 1)', 2 ** 63 - 1 == (float) (2 ** 63 - 1));
check('2 ** 63 - 1 < (float) (2 ** 63 - 1)', 2 ** 63 - 1 < (float) (2 ** 63 - 1));
...
$pairs = [
    '2 ** 63 - 1 <=> (float) (2 ** 63 - 1)' => [2 ** 63 - 1, (float) (2 ** 63 - 1)],
...
2 ** 63 - 1 == (float) (2 ** 63 - 1): bool(false)
2 ** 63 - 1 < (float) (2 ** 63 - 1): bool(true)
...
0 == -0.0: bool(true)
2 ** 64 <=> -0.0: int(1)
symmetry: 2 ** 63 - 1 <=> (float) (2 ** 63 - 1): bool(true)
