...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_ldap_compare, 0, 4, MAY_BE_BOOL|MAY_BE_INT)
	ZEND_ARG_OBJ_INFO(0, ldap, LDAP\\Connection, 0)
	ZEND_ARG_TYPE_INFO(0, dn, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, attribute, IS_STRING, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_ldap_exop_refresh, 0, 3, MAY_BE_INT|MAY_BE_FALSE)
	ZEND_ARG_OBJ_INFO(0, ldap, LDAP\\Connection, 0)
	ZEND_ARG_TYPE_INFO(0, dn, IS_STRING, 0)
