...
static ZEND_FUNCTION(zend_test_int_add)
{
	...
	zend_int_add(return_value, op1, op2);
}
...
static ZEND_FUNCTION(zend_test_int_sub)
{
	...
	zend_int_sub(return_value, op1, op2);
}
...
static ZEND_FUNCTION(zend_test_int_shift_left)
{
	...
	if (zend_int_shift_left(return_value, op1, op2) == FAILURE) {
		RETURN_THROWS();
	}
}
...
static ZEND_FUNCTION(zend_test_int_shift_right)
{
	...
	zend_int_shift_right(return_value, op1, op2);
}
...
static ZEND_FUNCTION(zend_test_int_pow)
{
	...
	if (zend_int_pow(return_value, op1, op2) == FAILURE) {
		RETURN_THROWS();
	}
}
