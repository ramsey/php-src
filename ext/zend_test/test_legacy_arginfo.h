...
ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_bigint_roundtrip, 0, 0, 1)
	ZEND_ARG_INFO(0, digits)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_bigint_cmp_strings, 0, 0, 2)
	ZEND_ARG_INFO(0, a)
	ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()

#define arginfo_zend_test_bigint_persist_roundtrip arginfo_zend_test_bigint_roundtrip

#define arginfo_zend_test_bigint_make arginfo_zend_test_bigint_roundtrip

#define arginfo_zend_test_int_is_boxed arginfo_zend_test_refcount

#define arginfo_zend_test_bigint_to_string arginfo_zend_test_refcount

ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_int_debug_str, 0, 0, 2)
	ZEND_ARG_INFO(0, v)
	ZEND_ARG_INFO(0, maxDigits)
ZEND_END_ARG_INFO()

#define arginfo_zend_test_int_add arginfo_zend_test_bigint_cmp_strings
...
#define arginfo_zend_test_int_div_trunc arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_mod arginfo_zend_test_bigint_cmp_strings
...
#define arginfo_zend_test_int_shift_left arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_shift_right arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_pow arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_cmp arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_cmp_long arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_cmp_double arginfo_zend_test_bigint_cmp_strings

#define arginfo_zend_test_int_sign arginfo_zend_test_refcount

#define arginfo_zend_test_int_is_odd arginfo_zend_test_refcount

#define arginfo_zend_test_int_bit_length arginfo_zend_test_refcount

#define arginfo_zend_test_int_to_double arginfo_zend_test_refcount

#define arginfo_zend_test_int_from_double arginfo_zend_test_refcount

ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_string_to_number, 0, 0, 1)
	ZEND_ARG_INFO(0, str)
	ZEND_ARG_INFO(0, allowErrors)
	ZEND_ARG_INFO(1, trailingData)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_zpp_int_clamp, 0, 0, 1)
	ZEND_ARG_INFO(0, n)
ZEND_END_ARG_INFO()
...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_FE(zend_test_flf_int_clamp, arginfo_zend_test_flf_int_clamp)
#if (PHP_VERSION_ID >= 80400)
...
static zend_class_entry *register_class__ZendTestBigintOperand(void)
{
	...
	zend_declare_property_ex(class_entry, property_fail_name, &property_fail_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_castable_name, &property_castable_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_castValue_name, &property_castValue_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_lastOpcode_name, &property_lastOpcode_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_lastOp1Type_name, &property_lastOp1Type_default_value, ZEND_ACC_PUBLIC, NULL);
	...
	zend_declare_property_ex(class_entry, property_lastOp2Type_name, &property_lastOp2Type_default_value, ZEND_ACC_PUBLIC, NULL);
