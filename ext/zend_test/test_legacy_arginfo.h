...
#define arginfo_zend_number arginfo_zend_string_or_object
...
#define arginfo_zend_test_bigint_fits_long arginfo_zend_test_bigint_string_roundtrip

#define arginfo_zend_test_make_bigint arginfo_zend_test_bigint_string_roundtrip

#define arginfo_zend_test_bigint_to_str arginfo_zend_test_refcount

ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_array_key_classify, 0, 0, 1)
	ZEND_ARG_INFO(0, candidate)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_zend_test_string_to_number, 0, 0, 1)
	ZEND_ARG_INFO(0, candidate)
	ZEND_ARG_INFO(0, allow_errors)
ZEND_END_ARG_INFO()
