...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_zend_test_bigint_roundtrip, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
...
#define arginfo_zend_test_int_sub arginfo_zend_test_int_add
...
#define arginfo_zend_test_int_mod arginfo_zend_test_int_add

#define arginfo_zend_test_int_mod_slow arginfo_zend_test_int_add

#define arginfo_zend_test_int_and arginfo_zend_test_int_add

#define arginfo_zend_test_int_or arginfo_zend_test_int_add
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zend_test_zpp_int, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, i, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zend_test_zpp_int_clamp, 0, 1, IS_LONG, 0)
