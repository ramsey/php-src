...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_gmp_init, 0, 1, GMP, 0)
	ZEND_ARG_TYPE_MASK(0, num, MAY_BE_INT|MAY_BE_STRING, NULL)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_gmp_export, 0, 1, IS_STRING, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, num, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, word_size, IS_LONG, 0, "1")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, flags, IS_LONG, 0, "GMP_MSW_FIRST | GMP_NATIVE_ENDIAN")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_gmp_add, 0, 2, GMP, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, num1, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_OBJ_TYPE_MASK(0, num2, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_gmp_powm, 0, 3, GMP, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, num, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_OBJ_TYPE_MASK(0, exponent, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_OBJ_TYPE_MASK(0, modulus, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_gmp_random_seed, 0, 1, IS_VOID, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, seed, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_gmp_random_range, 0, 2, GMP, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, min, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_OBJ_TYPE_MASK(0, max, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_gmp_binomial, 0, 2, GMP, 0)
	ZEND_ARG_OBJ_TYPE_MASK(0, n, GMP, MAY_BE_INT|MAY_BE_STRING, NULL)
	ZEND_ARG_TYPE_INFO(0, k, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_GMP___construct, 0, 0, 0)
	ZEND_ARG_TYPE_MASK(0, num, MAY_BE_INT|MAY_BE_STRING, "0")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, base, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()
